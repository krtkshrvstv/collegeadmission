...
class Fee():
    def __init__(self, master):
        ...
        Title_Frame = LabelFrame(
            Main_Frame, width=10, height=5, bg='white', relief='ridge', bd=15)
        Title_Frame.pack(side=TOP)

        self.lblTitle = Label(Title_Frame, font=('arial', 20, 'bold'), text='FEE REPORT',
                              bg='white', padx=10)
        self.lblTitle.grid(padx=20)

        Data_Frame = Frame(Main_Frame, width=100, height=50,
                           bg='white', bd=15)
        Data_Frame.pack(side=TOP, padx=15)

        Frame_1 = LabelFrame(Data_Frame, width=150, height=50, bg='white', bd=8,
                             text='Informations', font=('arial', 15, 'bold'))
        Frame_1.pack(side=LEFT, padx=0)

        Frame_2 = LabelFrame(Data_Frame, width=95, height=150, bg='white', relief='ridge', bd=8,
                             text='Fee Receipt', font=('arial', 15, 'bold'))
        Frame_2.pack(side=RIGHT, padx=5)

        List_Frame = Frame(Main_Frame, width=900, height=100,
                           bg='white', relief='ridge', bd=15)
        List_Frame.pack(side=TOP, padx=15)

        Button_Frame = Frame(Main_Frame, width=90, height=80,
                             bg='white', relief='ridge', bd=15)
        ...
        self.branch_entry = ttk.Combobox(Frame_1, values=(' ', 'CSE', 'IT', 'EXTC', 'Mechanical', 'Civil', 'EE'),
